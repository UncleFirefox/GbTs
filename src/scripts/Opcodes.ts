class Opcodes {
    ...
    LDmmSP = () => { console.debug('You called LDmmSP but I dont know what to do'); }
    ...
    RETI = () => { this.cpu.registers.ime=1; this.rrs(); this.cpu.registers.pc=this.mmu.readWord(this.cpu.registers.sp); this.cpu.registers.sp+=2; this.cpu.registers.m=3; }
    ...
    RST00 = () => { this.rsv(); this.cpu.registers.sp-=2; this.mmu.writeWord(this.cpu.registers.sp,this.cpu.registers.pc); this.cpu.registers.pc=0x00; this.cpu.registers.m=3; }
    RST08 = () => { this.rsv(); this.cpu.registers.sp-=2; this.mmu.writeWord(this.cpu.registers.sp,this.cpu.registers.pc); this.cpu.registers.pc=0x08; this.cpu.registers.m=3; }
    RST10 = () => { this.rsv(); this.cpu.registers.sp-=2; this.mmu.writeWord(this.cpu.registers.sp,this.cpu.registers.pc); this.cpu.registers.pc=0x10; this.cpu.registers.m=3; }
    RST18 = () => { this.rsv(); this.cpu.registers.sp-=2; this.mmu.writeWord(this.cpu.registers.sp,this.cpu.registers.pc); this.cpu.registers.pc=0x18; this.cpu.registers.m=3; }
    RST20 = () => { this.rsv(); this.cpu.registers.sp-=2; this.mmu.writeWord(this.cpu.registers.sp,this.cpu.registers.pc); this.cpu.registers.pc=0x20; this.cpu.registers.m=3; }
    RST28 = () => { this.rsv(); this.cpu.registers.sp-=2; this.mmu.writeWord(this.cpu.registers.sp,this.cpu.registers.pc); this.cpu.registers.pc=0x28; this.cpu.registers.m=3; }
    RST30 = () => { this.rsv(); this.cpu.registers.sp-=2; this.mmu.writeWord(this.cpu.registers.sp,this.cpu.registers.pc); this.cpu.registers.pc=0x30; this.cpu.registers.m=3; }
    RST38 = () => { this.rsv(); this.cpu.registers.sp-=2; this.mmu.writeWord(this.cpu.registers.sp,this.cpu.registers.pc); this.cpu.registers.pc=0x38; this.cpu.registers.m=3; }
    RST40 = () => { this.rsv(); this.cpu.registers.sp-=2; this.mmu.writeWord(this.cpu.registers.sp,this.cpu.registers.pc); this.cpu.registers.pc=0x40; this.cpu.registers.m=3; }
    RST48 = () => { this.rsv(); this.cpu.registers.sp-=2; this.mmu.writeWord(this.cpu.registers.sp,this.cpu.registers.pc); this.cpu.registers.pc=0x48; this.cpu.registers.m=3; }
    RST50 = () => { this.rsv(); this.cpu.registers.sp-=2; this.mmu.writeWord(this.cpu.registers.sp,this.cpu.registers.pc); this.cpu.registers.pc=0x50; this.cpu.registers.m=3; }
    RST58 = () => { this.rsv(); this.cpu.registers.sp-=2; this.mmu.writeWord(this.cpu.registers.sp,this.cpu.registers.pc); this.cpu.registers.pc=0x58; this.cpu.registers.m=3; }
    RST60 = () => { this.rsv(); this.cpu.registers.sp-=2; this.mmu.writeWord(this.cpu.registers.sp,this.cpu.registers.pc); this.cpu.registers.pc=0x60; this.cpu.registers.m=3; }
    ...
    /*--- Helper functions ---*/
    rsv = () => {
      this.backupregisters.a = this.cpu.registers.a; this.backupregisters.b = this.cpu.registers.b;
      this.backupregisters.c = this.cpu.registers.c; this.backupregisters.d = this.cpu.registers.d;
      this.backupregisters.e = this.cpu.registers.e; this.backupregisters.f = this.cpu.registers.f;
      this.backupregisters.h = this.cpu.registers.h; this.backupregisters.l = this.cpu.registers.l;
    }

    rrs = () => {
      this.cpu.registers.a = this.backupregisters.a; this.cpu.registers.b = this.backupregisters.b;
      this.cpu.registers.c = this.backupregisters.c; this.cpu.registers.d = this.backupregisters.d;
      this.cpu.registers.e = this.backupregisters.e; this.cpu.registers.f = this.backupregisters.f;
      this.cpu.registers.h = this.backupregisters.h; this.cpu.registers.l = this.backupregisters.l;
    }
